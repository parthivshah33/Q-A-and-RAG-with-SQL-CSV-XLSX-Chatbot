    ...
    def _process_uploaded_files(self) -> Tuple:
        ...
        for file_dir in self.files_dir:
            ...
            try :
                ...
                self.chatbot.append("Given Table name already exist in database. \n Solution : (1)Try to upload files after renaming It. or \n (2) You may be uploading same file again. Please Check.")
        print("==============================")
